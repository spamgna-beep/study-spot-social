          ...
          <div className="glass-strong rounded-2xl p-5 space-y-4 mb-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-muted text-sm focus:outline-none focus:ring-2 focus:ring-primary/30"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-2.5 rounded-xl bg-muted text-sm placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/30 resize-none"
              />
            </div>
          </div>
